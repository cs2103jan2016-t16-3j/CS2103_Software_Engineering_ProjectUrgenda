...
```
###### urgenda\command\BlockSlots.java
``` java
package urgenda.command;
...
```
###### urgenda\command\DeleteTask.java
``` java
package urgenda.command;
...
```
###### urgenda\command\Prioritise.java
``` java
package urgenda.command;
...
```
###### urgenda\command\SetDirectory.java
``` java
package urgenda.command;
...
```
###### urgenda\command\ShowDetails.java
``` java
package urgenda.command;
...
```
###### urgenda\command\TaskCommand.java
``` java
package urgenda.command;
...
```
###### urgenda\logic\LogicCommand.java
``` java
package urgenda.logic;
...
```
###### urgenda\logic\LogicSuggester.java
``` java
package urgenda.logic;
...
```
###### urgenda\util\LogicException.java
``` java
...
```
###### urgenda\util\MultipleSlot.java
``` java
package urgenda.util;
...
```
###### urgenda\util\SuggestCommand.java
``` java
package urgenda.util;
