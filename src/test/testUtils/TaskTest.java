...
public class TaskTest {
	...
	public void testIsImportant() {
		...
		Task obj4 = new Task(4, "Dental Appointment", "event", " ", true, false, false, LocalDateTime.now().minusHours(3), LocalDateTime.now().plusHours(1), LocalDateTime.now(), notime,  _tags, slot);
		Task obj5 = new Task(5, "Travel to Sweden", "event", " ", false, true, false, LocalDateTime.of(2016, Month.JULY, 26, 00, 00), LocalDateTime.of(2016, Month.AUGUST, 17, 23, 59), LocalDateTime.now(), notime,  _tags, slot);
	...
	public void testHasOverlap() {
		Task test = new Task();
		LocalDateTime start = LocalDateTime.of(2016, Month.MARCH, 9, 00, 00);
		LocalDateTime end = LocalDateTime.of(2016, Month.MARCH, 22, 00, 00);
		LocalDateTime comparestart1 = LocalDateTime.of(2016, Month.MARCH, 9, 00, 00);
		LocalDateTime compareend1 = LocalDateTime.of(2016, Month.MARCH, 22, 00, 00);
		LocalDateTime comparestart2 = LocalDateTime.of(2016, Month.MARCH, 19, 30, 00);
		LocalDateTime compareend2 = LocalDateTime.of(2016, Month.MARCH, 20, 45, 00);
		LocalDateTime comparestart3 = LocalDateTime.of(2016, Month.MARCH, 7, 15, 00);
		LocalDateTime compareend3 = LocalDateTime.of(2016, Month.MARCH, 11, 17, 00);
		LocalDateTime comparestart4 = LocalDateTime.of(2016, Month.MARCH, 12, 35, 00);
		LocalDateTime compareend4 = LocalDateTime.of(2016, Month.MARCH, 23, 30, 00);
		LocalDateTime comparestart5 = LocalDateTime.of(2016, Month.MARCH, 7, 00, 00);
		LocalDateTime compareend5 = LocalDateTime.of(2016, Month.MARCH, 9, 00, 00);
		LocalDateTime comparestart6 = LocalDateTime.of(2016, Month.MARCH, 22, 00, 00);
		LocalDateTime compareend6 = LocalDateTime.of(2016, Month.MARCH, 23, 00, 00);
		LocalDateTime comparestart7 = LocalDateTime.of(2016, Month.MARCH, 8, 00, 00);
		LocalDateTime compareend7 = LocalDateTime.of(2016, Month.MARCH, 23, 00, 00);
