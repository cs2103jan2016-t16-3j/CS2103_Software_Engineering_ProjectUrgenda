...
public class EditTest {
	...
	public void testExecute() throws Exception {
		...
		Task testTask = new Task(1, "Buy milk and eggs", "FLOATING", "", false, false, false, null, null, LocalDateTime.now(), null, null);
		...
		_data.setDisplays(_data.getTaskList());
		Task testTask2 = new Task(2, null, "EVENT", "", true, false, true, LocalDateTime.of(2016, Month.APRIL, 5, 10, 00), LocalDateTime.of(2016, Month.APRIL, 5, 12, 00), LocalDateTime.now(), null, null);
		Edit tester2 = new Edit();
		tester2.setNewTask(testTask2);
		tester2.setId(1);
		assertEquals("\"Submit ie2150 draft\" by 24/2, 23:59 has been edited to \"Submit ie2150 draft\" on 5/4 10:00 - 5/4 12:00 Warning: Event added has already passed", tester2.execute());
