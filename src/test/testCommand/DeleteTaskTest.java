...
public class DeleteTaskTest {
	...
	public void testExecute() throws LogicException {
		...
		assertEquals("\"Mop floor\" removed", test.execute()); //test deleting by desc
		...
		assertEquals("2 tasks have been removed: \"Buy milk\", \"Travel to Sweden\"", test2.execute()); //test deleting by position
	}
