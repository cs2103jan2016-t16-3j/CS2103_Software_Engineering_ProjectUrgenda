...
//		
//		File file = new File(TEST_FILE_LOCATION, TEST_FILE_NAME_2);
//		assertEquals(TEST_FILE_LOCATION, file.getParent());
//		assertEquals(TEST_FILE_NAME_2, file.getName());
//		
//		store.changeFilePath(TEST_FILE_LOCATION_2);
//		file = new File(TEST_FILE_LOCATION_2, TEST_FILE_NAME_2);
//		assertEquals()
//	}
