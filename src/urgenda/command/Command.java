...
public abstract class Command {
	...
	// generation of messages of task for edit fn whereby location of task may be edited
		...
		switch (taskType) {
			case EVENT :
				feedback = String.format(MESSAGE_EVENT, task.getDesc(), task.getStartTime().getDayOfMonth(),
						...
						task.getStartTime().getMinute(),task.getEndTime().getDayOfMonth(), task.getEndTime().getMonthValue(), task.getEndTime().getHour(), 
						task.getEndTime().getMinute());
				break;
